...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<johnemmettlk-facilitator_api1.gmail.com>";
    private string APIPassword = "<UKRHRU6N44KZ97AQ>";
    private string APISignature = "<AFcWxV21C7fd0v3bYYYRCpSSRl31A9nLZ5XpBp-EGAi0zduGQMBcPqaB>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44352/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44352/Checkout/CheckoutCancel.aspx";
